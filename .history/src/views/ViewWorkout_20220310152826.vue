<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      <!--Exercises-->
      <div
        class="mt-10 p-8 rounded-md flex flex-col item-center bg-light-gray shadow-md"
      >
        <!--Strength Training-->
        <div
          v-if="data.workoutType === 'strength'"
        ...
        >
          ...
          >
            ...
            <img
              ...
              src="@\assets\images\trash-light-green.png"
              alt=""
            />
          </div>
          <button
            v-if="edit"
            type="buttom"
            class="py-2 px-6 rounded-sm self-start
      text-sm text-white bg-at-light-green duration-200
      border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white
      ...
      <button
        v-if="edit"
        type="submit"
        class="mt-10 py-2 px-6 rounded-sm self-start
      text-sm text-white bg-at-light-green duration-200
      border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white
      hover:text-at-light-green"
      >
